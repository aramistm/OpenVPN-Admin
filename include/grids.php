<?php
  ...
  if(isset($_GET['select'])){
    ...
    // Select the logs
      ...
      $allowed_query_filters = ['user_id','log_trusted_ip','log_remote_ip']; // these are valid filters that could be used (defined here for sql security reason)
      ...
      if($data) {
        ...
        do {
          ...
          $sent = ($data['log_send'] > 1000000) ? $data['log_send']/1000000 . " MB" : $data['log_send']/1000 . " MB";
